...
#define LAUNCHD_KMOD "/Library/LaunchDaemons/com.zdziarski.FlockFlock.plist"
#define LAUNCHD_DAEMON "/Library/LaunchDaemons/com.zdziarski.FlockFlockDaemon.plist"
